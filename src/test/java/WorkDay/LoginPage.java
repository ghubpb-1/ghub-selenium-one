...
public class LoginPage {
    ...
    public static void main(String[] args) {
        // write selenium automation to navigate to https://rhb.wd102.myworkdayjobs.com/en-US/RHBExternalCareerSite/job/Singapore/Strategic-Planning-Executive_JR002072/apply/autofillWithResume?locationCountry=80938777cac5440fab50d729f9634969&jobFamilyGroup=dcd0863fd507101ae671d5c30bd80000&jobFamilyGroup=dcd0863fd507101ae671c45f7a330000
        // and enter tprakashbabu@yahoo.com at //*[@id="input-4"]
        // and enter password at //*[@id="input-5"] and in //*[@id="input-6"]
        System.out.println("LoginPage.java is running in the WorkDay package");
        ...
        System.out.println("Navigated to WorkDay login page");
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(java.time.Duration.ofSeconds(10));
        WebElement emailField = driver.findElement(By.xpath("//*[@id=\"input-4\"]"));
        emailField.sendKeys("tprakashbabu@yahoo.com");
        WebElement passwordField = driver.findElement(By.xpath("//*[@id=\"input-5\"]"));
        passwordField.sendKeys("Singapore@01");
        WebElement confirmPasswordField = driver.findElement(By.xpath("//*[@id=\"input-6\"]"));
        confirmPasswordField.sendKeys("Singapore@01");

        // Click the check box
        //*[@id="input-8"]
        WebElement checkBox = driver.findElement(By.xpath("//*[@id=\"input-8\"]"));
        if (!checkBox.isSelected()) {
            checkBox.click();
        } else {
            System.out.println("Checkbox is already selected");
        }
        // Click on the submit button /html/body/div/div/div/div[2]/div/main/div/div[3]/div/div/div[1]/div/form/div[6]/div/div/div/div/button
     //   WebElement submitButton = driver.findElement(By.xpath("/html/body/div/div/div/div[2]/div/main/div/div[3]/div/div/div[1]/div/form/div[6]/div/div/div/div/button"));
        WebElement submitButton = driver.findElement(By.xpath("//*[@aria-label=\"Create Account\"]"));
        submitButton.click();
        //button[@class='css-12zg065']

        driver.findElement(By.xpath("button[@class='css-12zg065']")).click();


        driver.findElement(By.xpath("//*[@data-automation-id=\"createAccountSubmitButton\"]")).click();
        System.out.println("LoginPage.java has completed successfully");
...
//        WebElement Button2 = driver.findElement(org.openqa.selenium.By.xpath("/html/body/div/div/div/div[2]/div/main/div/div[3]/div[2]/div[3]/div/button"));
//        Button2.click();
